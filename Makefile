...
ifdef MKLROOT
LDLIBS=-L$(MKLROOT)/lib/intel64 -lmkl_intel_lp64 -lmkl_intel_thread -lmkl_core  -L$(MKLROOT)/../compiler/lib/intel64 -liomp5 -lpthread -lm -ldl   vendor/wcstools-3.9.2/libwcs/libwcs.a -I$(MKLROOT)/include
CFLAGS:=$(CFLAGS) -I$(MKLROOT)/include
DEFINE=USE_MKL
else
#LDLIBS=-lm  -llapacke -llapack -lf77blas -latlas -lcblas -fopenmp  vendor/wcstools-3.9.2/libwcs/libwcs.a
LDLIBS=-lm    -lgfortran -llapacke -lblas -fopenmp  vendor/wcstools-3.9.2/libwcs/libwcs.a
#LDLIBS=-lm  -llapacke -llapack -lblas -lgslcblas -fopenmp -I/usr/include/lapacke vendor/wcstools-3.9.2/libwcs/libwcs.a
DEFINE=NO_MKL
endif
CPPFLAGS=$(addprefix -D,$(DEFINE))
#LDLIBS=-L$(MKLROOT)/lib/intel64 -lmkl_intel_lp64 -lmkl_intel_thread -lmkl_core  -L$(MKLROOT)/../compiler/lib/intel64 -liomp5 -lpthread -lm -ldl -fopenmp  vendor/wcstools-3.9.2/libwcs/libwcs.a
...
adam_debug:	adam.c $(LIBS)
	gcc $(CPPFLAGS) $(CFLAGS) -fsanitize=address -g   adam.c $(LIBS)  $(LDLIBS) -Ivendor/iniparser/src -Lvendor/iniparser -liniparser -o adam_debug

adam:	adam.c $(LIBS)
	$(CC) adam.c -o adam $(CPPFLAGS) $(CFLAGS)     $(LIBS)  $(LDLIBS) -Ivendor/iniparser/src -Lvendor/iniparser -liniparser 
	
thermal:	thermal.c $(LIBS)
	$(CC) $(CPPFLAGS) $(CFLAGS) thermal.c Calculate_Temp.c $(LIBS) $(LDLIBS)  -Ivendor/iniparser/src -Lvendor/iniparser -liniparser -o thermal
libs:	$(LIBS)

kiss_fftndr.o:	vendor/Kissfft/tools/kiss_fftndr.c
	$(CC) $(CFLAGS) -c $<

kiss_fft.o:	vendor/Kissfft/kiss_fft.c
	$(CC) $(CFLAGS) -c $<

kiss_fftr.o:	vendor/Kissfft/tools/kiss_fftr.c
	$(CC) $(CFLAGS) -c $<

kiss_fftnd.o:	vendor/Kissfft/tools/kiss_fftnd.c
	$(CC) $(CFLAGS) -c $<
