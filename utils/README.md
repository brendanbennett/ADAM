...
Assuming that MATLAB and the ini file are in the same directory (and paths to AO files are correct relative to MATLAB working directory), projections of reconstructed shape can be displayed with function `Display_ao_projections('inifile')`
